...
class UserParkResortScreen extends StatefulWidget {
  @override
  _UserParkResortScreenState createState() => _UserParkResortScreenState();
}

class _UserParkResortScreenState extends State<UserParkResortScreen> {
