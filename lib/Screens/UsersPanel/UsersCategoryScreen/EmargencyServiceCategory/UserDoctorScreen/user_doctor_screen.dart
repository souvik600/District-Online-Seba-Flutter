...
class UserDoctorScreen extends StatefulWidget {
  @override
  _UserDoctorScreenState createState() => _UserDoctorScreenState();
}

class _UserDoctorScreenState extends State<UserDoctorScreen> {
