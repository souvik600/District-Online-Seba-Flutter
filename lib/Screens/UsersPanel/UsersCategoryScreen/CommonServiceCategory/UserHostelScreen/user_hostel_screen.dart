...
class UserHostelScreen extends StatefulWidget {
  @override
  _UserHostelScreenState createState() => _UserHostelScreenState();
}

class _UserHostelScreenState extends State<UserHostelScreen> {
  ...
  void _openDetailsScreen(Map<String, dynamic> data) {
    Navigator.of(context).push(
        MaterialPageRoute(builder: (_) => HostelDetailsScreen(data: data)));
  }
