...
class UserWoodMistriServiceScreen extends StatefulWidget {
  @override
  _UserWoodMistriServiceScreenState createState() =>
      _UserWoodMistriServiceScreenState();
}

class _UserWoodMistriServiceScreenState
    extends State<UserWoodMistriServiceScreen> {
  final FirebaseFirestore _firestore = FirebaseFirestore.instance;
  final TextEditingController searchController = TextEditingController();
  bool _isLoading = false;
  String _searchQuery = '';

  Future<void> _registerWoodMistri(BuildContext context) async {
                    ...
                    onPressed: () async {
                      if (imageFile != null) {
                        ...
                        final storageRef = FirebaseStorage.instance
                            .ref()
                            .child('woodmistri_images/$imageId.jpg');

                        await storageRef.putFile(imageFile!);
                        final imageUrl = await storageRef.getDownloadURL();

                        await _firestore.collection('adminWoodMistri').add({
                          ...
                          'imageUrl': imageUrl,
                          'isVisible': false,
                          // Set to false initially for admin approval
                        });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar('কাঠ মিস্ত্রি'),
      floatingActionButton: FloatingActionButton(
        onPressed: () => _registerWoodMistri(context),
                  ...
                  child: StreamBuilder<QuerySnapshot>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      if (docs.isEmpty) {
                        return const Center(
                          child: Text(
                            'No approved Wood Mistri services available.',
