...
class UserCollegeScreen extends StatefulWidget {
  @override
  _UserCollegeScreenState createState() => _UserCollegeScreenState();
}

class _UserCollegeScreenState extends State<UserCollegeScreen> {
