...
class UserHighSchoolScreen extends StatefulWidget {
  @override
  _UserHighSchoolScreenState createState() => _UserHighSchoolScreenState();
}

class _UserHighSchoolScreenState extends State<UserHighSchoolScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar("উচ্চ বিদ্যালয়"),
      body: Stack(
        children: [
