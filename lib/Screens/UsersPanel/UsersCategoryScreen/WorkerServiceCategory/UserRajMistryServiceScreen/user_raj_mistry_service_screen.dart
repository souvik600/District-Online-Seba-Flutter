...
class UserRajMistriServiceScreen extends StatefulWidget {
  @override
  _UserRajMistriServiceScreenState createState() =>
      _UserRajMistriServiceScreenState();
}

class _UserRajMistriServiceScreenState
    extends State<UserRajMistriServiceScreen> {
  final FirebaseFirestore _firestore = FirebaseFirestore.instance;
  final TextEditingController searchController = TextEditingController();
  bool _isLoading = false;
  String _searchQuery = '';

  Future<void> _registerRajMistri(BuildContext context) async {
                    ...
                    onPressed: () async {
                      if (imageFile != null) {
                        ...
                        final storageRef = FirebaseStorage.instance
                            .ref()
                            .child('rajmistri_images/$imageId.jpg');

                        await storageRef.putFile(imageFile!);
                        final imageUrl = await storageRef.getDownloadURL();

                        await _firestore.collection('adminRajMistri').add({
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar('রাজ মিস্ত্রি'),
      floatingActionButton: FloatingActionButton(
        onPressed: () => _registerRajMistri(context),
                  ...
                  child: StreamBuilder<QuerySnapshot>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      if (docs.isEmpty) {
                        return const Center(
                          child: Text(
                            'No approved Raj Mistri services available.',
