...
import 'package:district_online_service/Styles/ElevatedButtonSubmit.dart';
...
class UserPlumberServiceScreen extends StatefulWidget {
  @override
  _UserPlumberServiceScreenState createState() =>
      _UserPlumberServiceScreenState();
}

class _UserPlumberServiceScreenState extends State<UserPlumberServiceScreen> {
  final FirebaseFirestore _firestore = FirebaseFirestore.instance;
  final TextEditingController searchController = TextEditingController();
  bool _isLoading = false;
  String _searchQuery = '';

  Future<void> _registerPlumber(BuildContext context) async {
              ...
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButtonSubmit(
                    onPressed: () async {
                      if (!_isLoading) { // Ensure the button is not pressed again while loading
                        setState(() {
                        ...
                        if (imageFile != null) {
                          ...
                          final storageRef = FirebaseStorage.instance
                              .ref()
                              .child('plumber_images/$imageId.jpg');
                          ...
                          await _firestore.collection('adminPlumber').add({
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar('প্লাম্বার'),
      floatingActionButton: FloatingActionButton(
        onPressed: () => _registerPlumber(context),
              ...
              children: [
                ...
                Expanded(
                  child: StreamBuilder<QuerySnapshot>(
                    stream: _firestore
                        .collection('userPlumber')
                        .where('isVisible',
                            isEqualTo: true) // Only show visible data
                        .snapshots(),
                    builder: (context, snapshot) {
                      ...
                      if (docs.isEmpty) {
                        return const Center(
                          child: Text(
                            'No approved plumber services available.',
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      image: const DecorationImage(
                                        image: AssetImage('assets/icons/plumber.png'),
                                        fit: BoxFit.contain,
                                      ),
