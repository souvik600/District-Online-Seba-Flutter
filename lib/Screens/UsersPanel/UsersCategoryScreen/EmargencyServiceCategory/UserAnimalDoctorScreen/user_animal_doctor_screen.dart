...
class UserAnimalDoctorScreen extends StatefulWidget {
  @override
  _UserAnimalDoctorScreenState createState() => _UserAnimalDoctorScreenState();
}

class _UserAnimalDoctorScreenState extends State<UserAnimalDoctorScreen> {
